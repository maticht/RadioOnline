    ...
    return (
        <div className={'mainFooterNavBarBlock'}>
            ...
            <p>
                ...
                <br></br>
                <br></br>
                Логотипы (товарные знаки), прошедшие официальную регистрацию, принадлежат их владельцам. Сайт <a href={'https://radio-online.me'}>Radio-Online.me</a> использует такие материалы в информационных целях.
                <br></br>
                <br></br>
                ...
                <br></br>
                <br></br>
                Если вы являетесь владельцем авторских прав или уполномочены действовать от их имени, пожалуйста, сообщите о предполагаемых нарушениях авторских прав. Укажите материал, который, по вашему мнению, нарушает авторские права предъявив убедительные доказательства. После получения уведомления, <a href={'https://radio-online.me'}>Radio-Online.me</a> оперативно отреагирует на заявления о нарушении авторского права, предпримет любые действия по своему усмотрению, в том числе удалит оспариваемый материал с сайта.
                <br></br>
                <br></br>
